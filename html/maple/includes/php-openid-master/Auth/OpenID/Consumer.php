...
class Auth_OpenID_AuthRequest {
     ...
     * will be replaced.
     *
     * 2013.07.13 NetCommons拡張 by AllCreator. 第5parameter $submit_text 追加。
     */
    function formMarkup($realm, $return_to=null, $immediate=false,
                        $form_tag_attrs=null, $submit_text="Continue")
    {
        $message = $this->getMessage($realm, $return_to, $immediate);
        ...
        return $message->toFormMarkup($this->endpoint->server_url,
                                      $form_tag_attrs,
									  $submit_text);	// NetCommons 拡張. $submit_textを追加
    }
    ...
    /**
     * Get a complete html document that will autosubmit the request
     * to the IDP. (for NetCommons 拡張 by AllCreator)
     *
     * Wraps formMarkup.  See the documentation for that function.
     */
    function htmlMarkupForNc($realm, $return_to=null, $immediate=false,
                        $form_tag_attrs=null,$mobile=false,$submit_text="Continue")
    {
        $form = $this->formMarkup($realm, $return_to, $immediate, 
        ...
        return Auth_OpenID::autoSubmitHTMLForNc($form,$mobile);
    }
